...
ifeq ($(DEBUG_MODE), 0)
CFLAGS=-O3 -ggdb -std=c++11 -fipa-sra -flto -Winline -Wall -Wno-pointer-arith -Wno-unused-function -D_GNU_SOURCE -I$(CONFIG_DIR) -I$(INCLUDE_DIR)
else
CFLAGS=-O0 -std=c++11 -Wall -Wno-pointer-arith -Wno-unused-function -g3 -DDEBUG -D_GNU_SOURCE -I$(CONFIG_DIR) -I$(INCLUDE_DIR)
endif

#ldflags
LDFLAGS=-lpthread -lm -march=native
